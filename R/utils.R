...
.make_x <- function(data, tz="local", check_xy=TRUE) {
  ...
  curl::curl_download("https://raw.githubusercontent.com/ABbiodiversity/wildRtrax-assets/main/lcc.tif", destfile = "lcc.tif")
  .rlcc <- terra::rast("lcc.tif")
  curl::curl_download("https://raw.githubusercontent.com/ABbiodiversity/wildRtrax-assets/main/tree.tif", destfile = "tree.tif")
  .rtree <- terra::rast("tree.tif")
  curl::curl_download("https://raw.githubusercontent.com/ABbiodiversity/wildRtrax-assets/main/seedgrow.tif", destfile = "seedgrow.tif")
  .rd1 <- terra::rast("seedgrow.tif")
  curl::curl_download("https://raw.githubusercontent.com/ABbiodiversity/wildRtrax-assets/main/utcoffset.tif", destfile = "utcoffset.tif")
