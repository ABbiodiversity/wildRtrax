...
All functions begin with a `wt_` prefix. Column names and metadata align with the WildTrax infrastructure. The general work flow is to use functions to pre-process media and metadata, upload it to WildTrax for processing or verification, then download and analyze the results. See the [book]() or [articles]() for more information. 
...
To report bugs, request additional features, or get help using the package, please file an [issue](https://github.com/ABbiodiversity/wildRtrax/issues). Alternatively, you can email Alex MacPhail <alex.macphail@ualberta.ca>,
