...
#Import BirdNET report and Tasks from project
BirdNET_df <- read.csv("C:/Users/User/Documents/WildTrax/Reports/BirdNET_report.csv")
Tasks_df <-read.csv("C:/Users/User/Documents/WildTrax/Reports/Task_report.csv")

#Combine data from BirdNET report and Tasks report to generate Tags report containing all BirdNET tags above a given threshold
tags_df <- wt_format_detections(BirdNET_df, Task_df, universal_threshold = "")

#Write csv for further use
write.csv(tags_df, "C:/Users/User/Documents/WildTrax/Reports/Tag_report_BirdNET.csv")
