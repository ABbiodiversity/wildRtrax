...
<<<<<<< HEAD:vignettes/acoustic-pre-processing.Rmd
...
>>>>>>> parent of 80f0ef0... Merge branch 'main' of https://github.com/ABbiodiversity/wildRtrax into main:vignettes/pre-processing-tools-in-wrt.Rmd
...
>>>>>>> parent of 80f0ef0... Merge branch 'main' of https://github.com/ABbiodiversity/wildRtrax into main:vignettes/pre-processing-tools-in-wrt.Rmd
```{r}
#Files in limited amplitude workflow, unnest the lists to get the detections 
less_tasks <- less %>%
