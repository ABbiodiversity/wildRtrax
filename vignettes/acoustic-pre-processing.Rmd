...
# Scan data
my_files <- wt_audio_scanner(path = root, file_type = "all", extra_cols = T)
...
wt_run_ap(x = my_files, output_dir = paste0(root, 'ap_outputs'), path_to_ap = )
