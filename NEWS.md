...
* Removed dependencies `pipeR`, `progressr`, `future`, `furrr`, `tools`, `magrittr`, `markdown`, `rmarkdown` to increase package stability. Moved `vembedr` to suggests for vignettes
