...
:::: {.didyouknow data-latex=""}
::: {.left data-latex=""}
*Did you know?*: Directories of acoustic data at the ABMI are organized in the following hierarchy.

- [**Organization**](): The institution or organization the data belongs to 
Sensor type: ARU
- [**Field Project**](): A field project differs from a [WildTrax project](). A WildTrax project can contain data from any field project whereas a field project is a hierarchical grouping of locations using a common naming convention. e.g. 1004-SW, 3-0-A1, OG-ABMI-EI-241-1 are all different location names from field projects, Ecosystem Health (ABMI-EH), Before-After Dose Response (BADR), Edge-Interior Off-Grids (OG-ABMI-EI)
- **Deployment Year**: The year the data was collected. Repeat visits of locations are defined in the year. 
...
distances <- wt_location_distances()


```

From here a user can filter a list of locations by 
