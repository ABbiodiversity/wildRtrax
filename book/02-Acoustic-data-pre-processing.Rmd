...
The columns from `wt_audio_scanner` are generated from the raw media file name in order to associate a file prefix to a location, the time stamp to a date and time, and so on. 
